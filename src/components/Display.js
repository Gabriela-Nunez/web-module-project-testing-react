...
const Display = (props) => {
  ...
  return (
    <div>
      ...
      <br />
      {!show ? <button button-testid='button' onClick={handleClick}>Press to Get Show Data</button> : <Show show={show} selectedSeason={selectedSeason} handleSelect={handleSelect} />}
    </div>
  );
}
